...
Проект реализует модель компьютерного зрения для обнаружения крупного рогатого скота на изображениях и видео с использованием архитектуры нейронной сети YOLOv8 на базе беспилотника Skyris техник про.

## Состав команды

| Имя | Роль | Контакты |
|-----|------|----------|
| Ботвинов Кирилл Игоревич (Ростех)| вайбкодер | ivan@example.com |
| Николайчук Дмитрий Сергеевич (Ростех)| Дизайнер | petr@example.com |
| Кувшинников Дмитрий Алексеевич (Ростех)| Гений | 75dk7575@gmail.com|
| Рыбаков Тихон Тихонович (НИЯУ МИФИ)| Просто прикольный тип  | endlessnotenough@yandex.ru |


##  Архитектура модели

### YOLOv8 (You Only Look Once v8)
YOLOv8 - это современная модель реального времени для детекции объектов, разработанная Ultralytics.
